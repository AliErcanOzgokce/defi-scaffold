...
module defi_scaffold::dex_tests {
    ...
    fun test_price_calculation_accuracy() {
        ...
        test_scenario::next_tx(&mut scenario, USER_ADDRESS);
        {
            ...
            let small_amount = 10;
            let small_output = dex_core::get_amount_out(&pair, small_amount, true);
            
            // Test medium swap amounts
            let medium_amount = 10000;
            let medium_output = dex_core::get_amount_out(&pair, medium_amount, true);
            
            // Test large swap amounts
            let large_amount = 100000;
            let large_output = dex_core::get_amount_out(&pair, large_amount, true);
            ...
            let very_small_output = dex_core::get_amount_out(&pair, very_small_amount, true);
